...
/**
 * Create a dialog component to to explain keyboard user how to trigger and remove FocusTrap
    ...
    function manageFocusDialog(evt: KeyboardEvent): void {
        ...
        if (evt.code === 'Tab' || evt.code === 'Enter') {
            ...
            if (evt.code === 'Tab') {
                ...
                // manage the exit of FpocusTrap, remove the trap and focus the top link
